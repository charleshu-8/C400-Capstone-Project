...
features = ["Packets", "Bytes", "Packets A → B", "Bytes A → B", "Packets B → A", "Bytes B → A", "Duration", "Bits/s A → B", "Bits/s B → A"]
...
targetDataSet = "sanitized_data/sanitized_data_2024-05-02_22-42-56-831810_mapped.csv"
